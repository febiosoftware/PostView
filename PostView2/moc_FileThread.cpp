...
void CFileThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CFileThread *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (CFileThread::*)(bool , const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CFileThread::resultReady)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject CFileThread::staticMetaObject = { {
    &QThread::staticMetaObject,
    qt_meta_stringdata_CFileThread.data,
    qt_meta_data_CFileThread,
    qt_static_metacall,
    nullptr,
    nullptr
} };
