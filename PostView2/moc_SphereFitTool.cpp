...
void CSphereFitTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CSphereFitTool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CSphereFitTool::staticMetaObject = { {
    QMetaObject::SuperData::link<CAbstractTool::staticMetaObject>(),
    qt_meta_stringdata_CSphereFitTool.data,
    qt_meta_data_CSphereFitTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
