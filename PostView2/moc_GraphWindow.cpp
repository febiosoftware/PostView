...
QT_MOC_LITERAL(1, 13, 30), // "on_selectX_currentIndexChanged"
QT_MOC_LITERAL(2, 44, 0), // ""
QT_MOC_LITERAL(3, 45, 30) // "on_selectY_currentIndexChanged"

    },
    "CGraphWindow\0on_selectX_currentIndexChanged\0"
    "\0on_selectY_currentIndexChanged"
};
...
void CGraphWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_selectX_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->on_selectY_currentIndexChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
