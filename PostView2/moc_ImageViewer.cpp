...
void CImageViewer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CImageViewer *_t = static_cast<CImageViewer *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject CImageViewer::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_CImageViewer.data,
      qt_meta_data_CImageViewer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CImageViewer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CImageViewer.stringdata0))
        return static_cast<void*>(const_cast< CImageViewer*>(this));
    if (!strcmp(_clname, "FEModelDependant"))
        return static_cast< FEModelDependant*>(const_cast< CImageViewer*>(this));
