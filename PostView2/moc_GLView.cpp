...
QT_MOC_LITERAL(1, 8, 12), // "repaintEvent"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "CGLView\0repaintEvent\0"
};
...
void CGLView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CGLView *_t = static_cast<CGLView *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->repaintEvent(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject CGLView::staticMetaObject = {
    { &QOpenGLWidget::staticMetaObject, qt_meta_stringdata_CGLView.data,
      qt_meta_data_CGLView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
