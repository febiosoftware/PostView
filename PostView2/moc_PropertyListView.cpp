...
QT_MOC_LITERAL(13, 169, 10), // "intChanged"
QT_MOC_LITERAL(14, 180, 1), // "s"
QT_MOC_LITERAL(15, 182, 12) // "floatChanged"
    ...
    "c\0intChanged\0s\0floatChanged"
};
#undef QT_MOC_LITERAL
...
void CPropertyListView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->intChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->floatChanged((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}
