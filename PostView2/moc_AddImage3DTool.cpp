...
void CAddImage3DTool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<CAddImage3DTool *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject CAddImage3DTool::staticMetaObject = { {
    &CAbstractTool::staticMetaObject,
    qt_meta_stringdata_CAddImage3DTool.data,
    qt_meta_data_CAddImage3DTool,
    qt_static_metacall,
    nullptr,
    nullptr
} };
