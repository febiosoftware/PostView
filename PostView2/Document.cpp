...
bool CDocument::AddStandardDataField(int ndata, bool bselection_only)
{
	...
	case 18: pdf = new FECurvatureField("1-Princ curvature"         , FECurvatureField::PRINC1_CURVATURE); break;
	case 19: pdf = new FECurvatureField("2-Princ curvature"         , FECurvatureField::PRINC2_CURVATURE); break;
	case 20: pdf = new FECurvatureField("Gaussian curvature"        , FECurvatureField::GAUSS_CURVATURE ); break;
	case 21: pdf = new FECurvatureField("Mean curvature"            , FECurvatureField::MEAN_CURVATURE  ); break;
	case 22: pdf = new FECurvatureField("RMS curvature"             , FECurvatureField::RMS_CURVATURE   ); break;
	case 23: pdf = new FECurvatureField("Princ curvature difference", FECurvatureField::DIFF_CURVATURE  ); break;
